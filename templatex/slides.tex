...
%
\title{FLIP00 Interim Inspection}%主标题
\author{
Cong Ma%作者
\\
...
rf=\href{http://www.tulip.org.au}{%可以放一个链接
%Last Changed By: \textsc{\gitCommitterName}\ \gitVtagn-\gitAbbrevHash\ (\gitAuthorDate)
Last Changed By: \textsc{\gitCommitterName}\ \gitVtagn-\gitAbbrevHash\ (\gitAuthorDate)
},
cf={FLIP00 Interim Inspection},%会议名称同主标题
}
...
%%==========================================================================================
%%
\begin{slide}{Background}%副标题
\begin{center}
\twotonebox{\rotatebox{90}{Defn}}{\parbox{.86\textwidth}
{Kobe Bryant marked his retirement from the NBA by scoring 
60 points in his final game as a Los Angeles Laker on Wednesday,
 April 12, 2016. Drafted into the NBA at the age of 17, 
 Kobe earned the sport’s highest accolades throughout his long career.
%\begin{itemize} 这里有他原本的描述
...
%%==========================================================================================
%%
\begin{slide}{Related Work - data collection}
%Related Work - Outlying Aspects Mining
\begin{itemize}
\item
Existing Methods - \textcolor{orange}{Download from kaggle}
\item
Existing Methods - \textcolor{orange}{Configure the running environment and load the required packages}
...
%%==========================================================================================
% TODO: Contact Page
\begin{wideslide}[toc=,bm=]{Thanks For Your Listening}
\centering
\vspace{\stretch{1}}
\twocolumn[
